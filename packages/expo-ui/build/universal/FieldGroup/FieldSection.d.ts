 ...
 */
export declare function FieldSection({ children, title, style, onAppear, onDisappear, hidden, testID, surfaceColor, titleUppercase, }: FieldSectionProps): import("react").JSX.Element;
